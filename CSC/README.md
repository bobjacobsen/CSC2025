...
by looking for the
[CSC-2025](https://github.com/bobjacobsen/CSC2025/releases/CSC-2025) release tag.
...
Style convention: Indented commands in `code font` are meant to
...
[Google Doc](https://docs.google.com/document/d/1Jvb1zYRibzOw74VKnGsmTVfWkQcOxb_yc8JboebFDpA/edit).
...
please see the
[Math class doc page](http://download.oracle.com/javase/8/docs/api/java/lang/Math.html).

For more information on the JUnit unit test classes for Java, see their
[class documentation](http://junit.sourceforge.net/javadoc/).

For more information on the CppUnit unit test classes for C++, see their
[web page](http://cppunit.sourceforge.net/doc/1.8.0/).

For more information on valgrind, see their
[documentation page](http://valgrind.org/docs/).

Information on Git:

- The [detailed Git documentation](https://www.kernel.org/pub/software/scm/git/docs/).
- Lots of [questions and answers](http://gitready.com) on Git usage.
