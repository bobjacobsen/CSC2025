...
We continually update the exercises in GitHub. After the School is complete, you can get the specific version we used by looking for the [CSC-2025](https://github.com/bobjacobsen/CSC2025/releases/CSC-2025) release tag.
